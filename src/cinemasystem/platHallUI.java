...
class platHallUI extends JFrame implements ActionListener{
    ...
    public platHallUI(int id, movie m, customer c) throws FileNotFoundException, IOException{
        ...
        public void actionPerformed(ActionEvent press){
            if(press.getSource()== exitJB){
                try {
                    ...
                    Logger.getLogger(platHallUI.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) throws IOException {
        ...
        movie m = null;
        customer c = null;
        platHallUI h = new platHallUI(id,m,c);
    }
